...
async def help_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    msg = (
        ...
        "/themes add NAME — Track a theme (auto-links tickers)\n"
        "/themes edit NAME — Modify a theme\n"
        "/themes info NAME — Theme details + notes\n"
        "/themes link    — Re-link all themes to watchlist\n"
